...
import EditPrerequisite from './EditPrerequisite';
...
const setIndexOfSelectedTab = (selectedTab: 'Topic'| 'Pathway'| 'Pre-requisite') => {
...
export default function Edit(props: EditProps) {
  ...
  const [selectedIndex, setSelectedIndex] = useState<number>(setIndexOfSelectedTab(props.selectedSubTab));
  ...
  return (
    <div className="pb-1 px-5 overflow-y-auto w-full">
      <Tab.Group selectedIndex={selectedIndex} onChange={ind => props.setSelectedSubTab(setNameOfTab(ind))}>
        <div className="bg-gray-900 h-auto fixed py-4 z-10" style={{width: '15.5rem'}}>
          <h1 className=" pb-1 text-lg font-medium text-white">Edit:</h1>
          <Tab.List className="flex space-x-1 rounded-xl bg-blue-300/20 p-1 text-blue-100">
            <Tab aria-label='Topic' title='Topic'
              className={({ selected }) =>
                classNames(
            ...
            >
              <svg height="100%" viewBox="-2.4 -2.4 28.80 28.80" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" stroke="inherit" strokeWidth="2.256"></g><g id="SVGRepo_iconCarrier"> <path d="M3 10H21M6 7.5H6.01M9 7.5H18M6.2 19H17.8C18.9201 19 19.4802 19 19.908 18.782C20.2843 18.5903 20.5903 18.2843 20.782 17.908C21 17.4802 21 16.9201 21 15.8V8.2C21 7.0799 21 6.51984 20.782 6.09202C20.5903 5.71569 20.2843 5.40973 19.908 5.21799C19.4802 5 18.9201 5 17.8 5H6.2C5.0799 5 4.51984 5 4.09202 5.21799C3.71569 5.40973 3.40973 5.71569 3.21799 6.09202C3 6.51984 3 7.07989 3 8.2V15.8C3 16.9201 3 17.4802 3.21799 17.908C3.40973 18.2843 3.71569 18.5903 4.09202 18.782C4.51984 19 5.07989 19 6.2 19Z" strokeWidth="0.8399999999999999" strokeLinecap="round" strokeLinejoin="round"></path> </g></svg>
              <p>Topic</p>
            </Tab>
            <Tab aria-label='Pre-requisite Relationship' title='Pre-requisite Relationship'
              className={({ selected }) =>
                classNames(
                  'flex flex-col justify-around items-center w-full rounded-lg py-1 flex justify-center text-xs font-medium leading-none h-12',
                  'ring-white ring-opacity-60 ring-offset-2 ring-offset-blue-400 focus:outline-none focus:ring-2',
            ...
            >
              {props.selectedTopic 
                ? <EditTopic 
                  ...
                  />
                : <h2 className=" py-1 text-center text-medium font-medium text-gray-600">Please select a Topic from the Topic Tree to edit</h2>
              }
            </Tab.Panel>
            <Tab.Panel
              className={classNames(
            ...
            >
              {props.selectedPrereq 
                ? <EditPrerequisite 
                  ...
                  graphForDetectingCycles={props.graphForDetectingCycles}
                />
                : <h2 className=" py-1 text-center text-medium font-medium text-gray-600">Please select a Prerequisite from the Topic Tree to edit</h2>
              }
            </Tab.Panel>
        </Tab.Panels>
      </Tab.Group>
