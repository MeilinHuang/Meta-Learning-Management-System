...
import DetailsTopic from './DetailsTopic';
import DetailsPrerequisite from './DetailsPrerequisite';
import DetailsPathway from './DetailsPathway';
    ...
    <div className="pb-1 px-5 overflow-y-auto w-full">
      ...
      >
        <div
          ...
          style={{ width: '15.5rem' }}
        >
          <h1 className=" pb-1 text-lg font-medium text-white">Details:</h1>
        ...
        <Tab.Panels className="mt-32">
          ...
          >
            {props.selectedTopic ? (
              ...
              <h2 className=" py-1 text-center text-medium font-medium text-gray-600">
                Please select a Topic from the Topic Tree to view details
              </h2>
            )}
          </Tab.Panel>
          <Tab.Panel
          ...
          >
            {props.selectedPrereq ? (
              ...
              <h2 className=" py-1 text-center text-medium font-medium text-gray-600">
                Please select a Prerequisite from the Topic Tree to view details
              </h2>
            )}
          </Tab.Panel>
        </Tab.Panels>
