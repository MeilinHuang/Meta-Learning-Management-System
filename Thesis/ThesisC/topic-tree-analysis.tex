...
To assess the feature, each topic group will contain 1-10 topics to simulate a real world topic group. The feature will be tested with 3, 5, 10, 20, 50, 100, and 300 topic groups. The School of CSE currently runs around 100 courses, and so as this topic tree is designed to be used by a faculty or school, 300 topic groups is the limit that will be tested. Ideally, disciplines will be implemented in the future which will create separate topic trees for each school or faculty. \\

Each test will be assessed by measuring the performance using Google Lighthouse i.e. the time to finish loading the website. Several operations will be undertaken including: \\
\begin{itemize}
    \item Clicking a topic group to expand into individual topics
    \item Creating a new topic
    \item Deleting a prerequisite
