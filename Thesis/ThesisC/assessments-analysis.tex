...
*For simplicity sake, instead of allowing the course lecturer to create a question bank, the default is a single question b ank exists to store all questions that want to be used in future quizzes. 
