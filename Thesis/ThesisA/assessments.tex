...
\subsection{Required Training/Upskilling}
...
\begin{figure}[!hbpt]
	\centering
	\includegraphics[scale=0.35]{assessments-thesis-a}
...
\begin{figure}[!hbpt]
	\centering
	\includegraphics[scale=0.35]{assessments-thesis-b}
...
\begin{figure}[!hbpt]
	\centering
	\includegraphics[scale=0.35]{assessments-thesis-c}
