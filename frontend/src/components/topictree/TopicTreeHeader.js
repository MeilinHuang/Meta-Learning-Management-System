      ...
      for (let topic of topicGroup.topics_list) {
        ...
        if (topic.tags !== undefined) {
          for (let tag of topic.tags) {
            tempTopics.push({
              value: topic.name,
              label: tag.name + " - " + topicGroup.name,
              id: topic.id,
              name: topic.name,
              course_materials: topic.course_materials,
              tags: topic.tags,
              group: topicGroup.name,
