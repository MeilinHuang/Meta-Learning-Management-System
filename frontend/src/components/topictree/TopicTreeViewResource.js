...
export default function TopicTreeViewResource({
  data,
  isOpen,
  onClose,
  prereqs,
    ...
    <>
      <Modal isOpen={isOpen} onClose={() => closeModal()} size={"xl"}>
        ...
        <ModalContent>
          ...
          <ModalBody>
            <Box>
              <Box>
                      ...
                      <Tr>
                        ...
                        <Td>
                          ...
                          >
                            ...
                            <CloseButton onClick={hideAddPrereq} />
                          </Flex>
                        </Td>
                      </Tr>
                    ) : (
                ...
                {tempPrereqs.length == 0 ? (
                  <h6>No prerequisites here!</h6>
                ) : (
                  <></>
                )}
                <Button mb={5} colorScheme="blue" onClick={showAddPrereq}>
                  Add prerequisite
                </Button>
              </Box>
              <Box>
                ...
                <Table variant="simple" mb={8}>
                  <Tbody>
                      ...
                      <Tr>
                        ...
                        <Td>
                          <Flex
                            ...
                            justifyContent="space-between"
                          >
                            <Button colorScheme="green" onClick={createNewTag}>
                              Create
                            </Button>
                            <CloseButton onClick={hideAddTag} />
                          </Flex>
                        </Td>
                      </Tr>
                    ) : (
                    ...
                    <Button mb={5} colorScheme="blue" onClick={showAddTag}>
                      Add Tag
                    </Button>
                  </Tbody>
                </Table>
                ...
                return (
                  <Box key={typeOfFile} mb={3}>
                    ...
                    <Table variant="simple">
                      ...
                      <Tbody>
                        {data.materials_strings[typeOfFile.toLowerCase()].map(
                          (file_string) => {
                            return (
                              <Tr key={file_string}>
                                <Td>{file_string}</Td>
                    ...
                    {data.materials_strings[typeOfFile.toLowerCase()].length ==
                    0 ? (
                      <h6>No files here!</h6>
                    ) : (
                      <></>
                    ...
                    <Flex flexDirection="column" mb="16px">
                      <input
                        type="file"
                        name="images"
                        onChange={(e) => handleUpload(e, typeOfFile)}
                      />
                      <Button
                        colorScheme="blue"
                        mt={3}
                        onClick={(e) => uploadFile(e, typeOfFile)}
                      >
                        Upload file
                      </Button>
                    </Flex>
          ...
          <ModalFooter>
            <Flex>
              <Button colorScheme="red" mr={3} onClick={deleteTopic}>
                Delete Topic
              </Button>
