...
export default function TopicGroupList() {
    ...
    <>
        ...
        <Box padding={5}>
            ...
            <Heading as="h5" size="sm" marginLeft={4}>Click on a topic group to view the graph</Heading>
            <Stack spacing={5} divider={<Divider></Divider>} marginTop={10}>
                {data.map(e => {
                    return (
                        <Flex key={"topic-group-" + e.id} paddingTop={5} paddingBottom={5} justifyContent="auto">
                            <Button as={Flex} bg="white" cursor="pointer" flexGrow={1}>
                                ...
                                <Box marginLeft={10} fontSize="sm">
                                    <Text>
                                        {e.topics_list.length.toString()} topics
                                    </Text>
                                </Box>
                                <Box flexGrow={1}></Box>
                            </Button>
                            <Box flexGrow={0.1}></Box>
                            <Button bg="blue.500" color="white" onClick={() => handleClick(e.name)}>Go to Topic Graph</Button>
                        </Flex>
                    )
                })}
            </Stack>
