        ...
        <DrawerHeader>
          ...
          >
            {enrolled.map((course) => {
              return (
                <option
                  key={"sidebar-menu-" + course.topic_code}
                  value={course.name}
                >
                  {course.topic_code}
                </option>
          ...
          <MenuButton>
            ...
            >
              <Box marginLeft={1} padding={4} fontSize="larger">
                ...
                <Text fontSize="medium" letterSpacing="wider">
                  {groupState["object"].name}
                </Text>
              </Box>
            </Flex>
          </MenuButton>
          <Portal>
            ...
            >
              {enrolled.map((e) => {
                ...
                return (
                  <MenuItem key={"course-menu-" + e.topic_code} value={e.name}>
                    {e.topic_code}
                  </MenuItem>
                );
              })}
